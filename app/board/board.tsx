  ...
  return (
    <div className="app">
      ...
      <nav className="rail" aria-label="Sections">
        ...
        <Link className="rl" href="/ops?stage=waiting" aria-label="Quotes"><svg width="17" height="17" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="3" y="2" width="10" height="12" rx="1.5"/><path d="M5.5 6h5M5.5 9h3"/></svg></Link>
        <Link className="rl" href="/ops?view=promises" aria-label="Promises"><svg width="17" height="17" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M3 8.5 6.5 12 13 4.5"/></svg></Link>
